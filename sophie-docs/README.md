...
**Sophie** is an AI-powered product design mentor that combines 12 specialized expertise areas, 80+ design methodologies, and persistent memory to guide you through complex product design challenges.
...
Sophie evolved from the [Product Design Agent](https://github.com/jcmrs/product-design-agent) — a sophisticated file-based AI mentorship system for Claude Desktop and Gemini Gems.

**The Challenge:**
Platform constraints (session limits, no memory, token usage) prevented the agent from reaching its full potential.

**The Solution:**
Rebuild as an independent CLI application that preserves the collaborative essence while adding:
...
The original [Product Design Agent](https://github.com/jcmrs/product-design-agent) implementation remains available as reference and for users who prefer the Claude Desktop/Gemini Gems approach.

A complete archive of the original implementation is maintained in this repository under `/archive/` for study and analysis.

---

## Contact & Community

**Repository:** https://github.com/jcmrs/sophie
**Original Project:** https://github.com/jcmrs/product-design-agent
